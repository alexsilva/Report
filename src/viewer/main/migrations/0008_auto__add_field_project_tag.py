...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.tag'
        db.add_column('main_project', 'tag',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.tag'
        db.delete_column('main_project', 'tag')
    ...
    models = {
        ...
        'main.project': {
            ...
            'tag': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        'main.yearlyplan': {
