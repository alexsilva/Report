...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HoursAdd.yearlyplan'
        db.add_column('main_hoursadd', 'yearlyplan',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.YearlyPlan']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HoursAdd.yearlyplan'
        db.delete_column('main_hoursadd', 'yearlyplan_id')
