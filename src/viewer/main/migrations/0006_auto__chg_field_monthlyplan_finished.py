...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MonthlyPlan.finished'
        db.alter_column('main_monthlyplan', 'finished', self.gf('django.db.models.fields.DateField')(default=None))

    def backwards(self, orm):

        # Changing field 'MonthlyPlan.finished'
        db.alter_column('main_monthlyplan', 'finished', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'main.monthlyplan': {
            ...
            'finished': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
