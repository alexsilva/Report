...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.tag'
        db.alter_column('main_project', 'tag', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Project.tag'
        db.alter_column('main_project', 'tag', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))
    ...
    models = {
        ...
        'main.project': {
            ...
            'tag': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'blank': 'True'})
        },
        'main.yearlyplan': {
